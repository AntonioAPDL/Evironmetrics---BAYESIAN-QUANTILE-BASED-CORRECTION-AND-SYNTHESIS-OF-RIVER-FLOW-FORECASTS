...
Table~\ref{tab:benchmark_crps_models} shows a clear ranking pattern. The two multivariate synthesis models with transfer function active during the forecast window (AL-M-T1 and exAL-M-T1) dominate the comparison. exAL-M-T1 is the best-performing model in three cutoffs (11/12/2021, 12/21/2021, and 12/25/2022), while AL-M-T1 is the best-performing model in the other two (01/23/2021 and 05/11/2022). In all five cutoffs, the best Bayesian corrected model outperforms the best raw physical ensemble baseline. This comparison highlights the value of combining retrospective analyses and ensemble forecasts within the synthesis framework, and it motivates our detailed focus below on the exAL specification as the most consistently strong model across cutoffs.
